...
var changeModalState = function changeModalState(state) {
  var windowForm = document.querySelectorAll('.balcon_icons_img'),
      windewWidth = document.querySelectorAll('#width'),
      windewHeight = document.querySelectorAll('#height'),
      windewType = document.querySelectorAll('#view_type'),
      windewProfile = document.querySelectorAll('.checkbox');
  ...
  bindActionToElems('input', windewWidth, 'width');
  bindActionToElems('input', windewHeight, 'height');
  bindActionToElems('change', windewType, 'type');
  bindActionToElems('change', windewProfile, 'profile');
};
